...
public class Constants {
  ...
  public static final String[] baseModDB = {"Accelerated Blast,Shotgun,3,2,FireRate,PunctureDamage,0.15,0.15,V,6",
                                            ...
                                            //Arch-Gun Mods
                                            "Ammo Chain,ArcGun,5,1,AmmoCap,0.167,~,2",
                                            "Arch-Gun Ace,ArcGun,5,2,FireRate,ReloadSpeed,0.08,0.17,V,6",
                                            "Automatic Trigger,ArcGun,5,1,FireRate,0.1,V,10",
                                            "Charged Bullets,ArcGun,3,2,ElectricDamage,StatusChance,0.15,0.15,V,4",
                                            "Combustion Rounds,ArcGun,5,1,FireDamage,0.2,V,4",
                                            "Comet Blast,ArcGun,5,1,ImpactDamage,0.15,~,2",
                                            "Contamination Casing,ArcGun,3,2,ToxinDamage,StatusChance,0.15,0.15,V,4",
                                            "Critical Focus,ArcGun,5,2,CritChance,CritMultiplier,0.1,0.1,V,6",
                                            "Deadly Efficiency,ArcGun,5,1,Damage,0.2,V,4",
                                            "Dual Rounds,ArcGun,5,1,Multishot,0.1,V,6",
                                            "Electrified Barrel,ArcGun,5,1,ElectricDamage,0.2,V,4",
                                            "Hollowed Bullets,ArcGun,3,1,CritMultiplier,0.2,V,4",
                                            "Hypothermic Shell,ArcGun,3,2,IceDamage,StatusChance,0.15,0.15,V,4",
                                            "Magazine Extension,ArcGun,5,1,MagCap,0.1,~,4",
                                            "Magma Chamber,ArcGun,3,2,FireDamage,StatusChance,0.15,0.15,V,4",
                                            "Marked Target,ArcGun,5,1,StatusChance,0.2,V,6",
                                            "Modified Munitions,ArcGun,5,1,StatusChance,0.1,D,4",
                                            "Parallax Scope,ArcGun,3,1,CritChance,0.25,~,4",
                                            "Polar Magazine,ArcGun,5,1,IceDamage,0.2,D,4",
                                            "Quasar Drill,ArcGun,5,1,PunctureDamage,0.15,~,2",
                                            "Quick Reload,ArcGun,3,1,ReloadSpeed,0.25,~,2",
                                            "Resolute Focus,ArcGun,5,1,SpreadBonus,-0.08,~,4",
                                            "Rubedo-Lined Barrel,ArcGun,5,1,Damage,0.167,V,6",
                                            "Sabot Rounds,ArcGun,5,2,Damage,PunchThrough,0.1,0.005,~,10",
                                            "Shell Rush,ArcGun,3,1,FireRate,0.125,D,4",
                                            "Venomous Clip,ArcGun,5,1,ToxinDamage,0.2,D,4",
                                            "Zodiac Shred,ArcGun,5,1,SlashDamage,0.15,~,2"
                                            };
