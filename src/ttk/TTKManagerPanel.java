...
public class TTKManagerPanel extends JPanel implements ActionListener, ListSelectionListener  {
  ...
  public void buildUI(){
    ...
    baseArmorPanel.setLayout(new GridLayout(1,3,0,0));
    ...
    targetScroll.setPreferredSize(new Dimension(150, 230));
  ...
  /**
   * Updates the values on the right side to those of the target selected on the left side
   */
