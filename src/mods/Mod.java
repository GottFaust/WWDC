...
public class Mod implements Comparable {
	...
	public Mod(String modString) {
		...
		if (!(tempPolarity.equals(Constants.D) || tempPolarity.equals(Constants.V) || tempPolarity.equals(Constants.DASH) || tempPolarity.equals(Constants.EQUALS))) {
